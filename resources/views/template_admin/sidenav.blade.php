   ...
   <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
     <ul class="flex flex-col pl-0 mb-0">
      @if (Str::length(Auth::guard('admin')->user()) > 0)
       ...
       <li class="mt-0.5 w-full">
         <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
         {{ request()->segment(1) == 'pemesanan-selesai' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}" 
         href="{{ route('pemesananSelesai') }}">
           <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
       ...
       <li class="mt-0.5 w-full">
         <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
         {{ request()->segment(1) == 'pemesanan-batal' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}" 
         href="{{ route('pemesananBatal') }}">
           <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
             <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
               <title>pemesanan batal</title>
               <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
        {{ request()->segment(1) == 'pengguna' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}
        {{ request()->segment(1) == 'pengguna-add' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}
        {{ request()->segment(1) == 'pengguna-detail' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}" 
        href="{{ route('pengguna') }}"> 
          <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors 
        {{ request()->segment(1) == 'dashboard-pengemudi' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}" 
        href="{{ route('dashboardPengemudi') }}">
          <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>dashboard</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
        {{ request()->segment(1) == 'pengemudi-pesanan' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}
        {{ request()->segment(1) == 'detail-pengemudi-pesanan' ? 'shadow-soft-xl rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800 font-semibold text-white' : '' }}" 
        href="{{ route('pesananPengemudi') }}"> 
          <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
              <title>pesanan</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
