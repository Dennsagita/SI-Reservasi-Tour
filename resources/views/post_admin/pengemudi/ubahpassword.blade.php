...
@section('action')
@section('title', 'Ubah Password Pengemudi')
          ...
          <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
            <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
              ...
              <div class="flex-auto p-6">
                <form action="{{ route('processpasswordPengemudi') }}" method="post">
                  {{ csrf_field() }}
                  <label class="mb-2 ml-1 cursor-pointer select-none text-sm font-bold text-slate-700" for="old_password"> Password Lama</label>
                  <div class="mb-4">
                    <input type="password" id="old_password" name="old_password" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Password Lama" aria-label="old_password" aria-describedby="email-addon" />
                  </div>
                  <label class="mb-2 ml-1 cursor-pointer select-none text-sm font-bold text-slate-700" for="new_password"> Password Baru</label>
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    <input type="password" id="new_password_confirm" name="new_password_confirm" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Konfirmasi Paswword" aria-label="new_password_confirm" aria-describedby="password-addon" />
                  </div>
