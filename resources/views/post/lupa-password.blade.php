        ...
        <div class="container z-10">
          <div class="flex flex-wrap justify-center -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                <h1 class="mt-12 mb-2 text-white">Selamay Datang!</h1>
                <p class="text-white">Anda melupkan password, silakan untuk melakukan reset password agar bisa masuk ke akun anda</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
            <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
                <h5 class="font-bold">Reset Password</h5>
              </div>
              @if ($errors->any())
              ...
              <div class="flex-auto p-6">
                <form action="{{ route('password.processLupaPassword') }}" method="POST">
                  {{ csrf_field() }}
                  <label class="mb-2 ml-1 cursor-pointer select-none text-sm font-bold text-slate-700" for="old_password">Email</label>
                  <div class="mb-4">
